...
#define F_FILTERID    FilterCurvatureSkeleton::RESTORE_HACK_VALUES
#define F_DISPLAYNAME "Restore Hack Order Data"
...
RestoreHackOrderDataFilter::RestoreHackOrderDataFilter()
	: TemplateFilter(
