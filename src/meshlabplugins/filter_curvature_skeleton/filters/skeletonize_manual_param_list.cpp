...
#define SKELETAL_DISTANCE_TO_MESH_QUALITY_DEFAULT true
#define SKELETON_INDEX_TO_MESH_ATTRIBUTES_DEFAULT true
...
#define SKELETON_INDEX_TO_MESH_ATTRIBUTES_DISPLAYNAME "Save Skeleton Index in the mesh additional attributes"
#define SKELETON_INDEX_TO_MESH_ATTRIBUTES_DESCRIPTION "If ticked, the algorithm will save the index of the skeleton's vertices to which have collapsed the vertices of the mesh in an additional per vertex attribute."
...
RichParameterList filterSkeletonizeManual::initParameterList(FilterPlugin const&, MeshModel const& m)
{
	...
	parlst.addParam(RichBool(PARAM_SAVE_SKELETON_INDEX_TO_MESH_ATTRIBUTES, SKELETON_INDEX_TO_MESH_ATTRIBUTES_DEFAULT, SKELETON_INDEX_TO_MESH_ATTRIBUTES_DISPLAYNAME, SKELETON_INDEX_TO_MESH_ATTRIBUTES_DESCRIPTION, false, GENERIC_CATEGORY));
