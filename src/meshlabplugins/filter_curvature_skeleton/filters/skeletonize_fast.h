...
#ifndef FILTERCURVATURESKELETON_FILTER_SKELETONIZE_FAST
#define FILTERCURVATURESKELETON_FILTER_SKELETONIZE_FAST

#include "filter_template.h"

#include "../filter_curvature_skeleton.h"

class filterSkeletonizeFast : public templateFilter
{
public:
	filterSkeletonizeFast();
	~filterSkeletonizeFast();
