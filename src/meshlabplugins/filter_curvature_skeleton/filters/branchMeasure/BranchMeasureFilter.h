...
#ifndef FILTERCURVATURESKELETON_FILTER_BRANCH_MEASURE
#define FILTERCURVATURESKELETON_FILTER_BRANCH_MEASURE
...
class BranchMeasureFilter : public TemplateFilter
{
public:
	BranchMeasureFilter();
...
#endif //FILTERCURVATURESKELETON_FILTER_BRANCH_MEASURE
