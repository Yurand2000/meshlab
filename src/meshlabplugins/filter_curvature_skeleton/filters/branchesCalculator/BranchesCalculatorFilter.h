...
#ifndef FILTERCURVATURESKELETON_FILTER_BRANCHES_CALCULATOR
#define FILTERCURVATURESKELETON_FILTER_BRANCHES_CALCULATOR
...
class BranchesCalculatorFilter : public TemplateFilter
{
public:
	BranchesCalculatorFilter();
...
#endif //FILTERCURVATURESKELETON_FILTER_BRANCHES_CALCULATOR
