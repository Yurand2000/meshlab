...
std::map<std::string, QVariant> FindPathFillTestFilter::applyFilter(
	...
	vcg::CallBackPos*		 cb)
{
	...
	auto path = EdgeMeshUtils<SkeletonMesh>::getVerticesInBetween(skeleton_mesh, start_vertex, end_vertex);
