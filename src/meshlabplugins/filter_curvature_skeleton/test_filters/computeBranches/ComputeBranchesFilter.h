...
#ifndef FILTERCURVATURESKELETON_TEST_FILTER_COMPUTE_BRANCHES
#define FILTERCURVATURESKELETON_TEST_FILTER_COMPUTE_BRANCHES
...
class ComputeBranchesTestFilter : public TemplateFilter
{
public:
	ComputeBranchesTestFilter();
