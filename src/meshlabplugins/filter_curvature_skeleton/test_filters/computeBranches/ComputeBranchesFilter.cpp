...
#define F_FILTERID    TestFilters::COMPUTE_BRANCHES
#define F_DISPLAYNAME "TEST - Compute Branches"
#define F_DESCRIPTION ""
#define F_CATEGORY    FilterPlugin::Other
#define F_PYTHON_NAME "test_filter___compute_branches"
...
ComputeBranchesTestFilter::ComputeBranchesTestFilter()
	: TemplateFilter(
