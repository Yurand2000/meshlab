...
#define F_FILTERID    TestFilters::COMPUTE_POLYLINES
#define F_DISPLAYNAME "TEST - Compute Polylines"
#define F_DESCRIPTION ""
#define F_CATEGORY    FilterPlugin::Other
#define F_PYTHON_NAME "test_filter___compute_polylines"
...
ComputePolylinesTestFilter::ComputePolylinesTestFilter()
	: TemplateFilter(
