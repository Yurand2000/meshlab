...
#ifndef FILTERCURVATURESKELETON_TEST_FILTER_COMPUTE_POLYLINES
#define FILTERCURVATURESKELETON_TEST_FILTER_COMPUTE_POLYLINES
...
class ComputePolylinesTestFilter : public TemplateFilter
{
public:
	ComputePolylinesTestFilter();
...
#endif //FILTERCURVATURESKELETON_TEST_FILTER_COMPUTE_POLYLINES
