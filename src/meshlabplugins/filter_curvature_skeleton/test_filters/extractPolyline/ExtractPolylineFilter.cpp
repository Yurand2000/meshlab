...
#define F_FILTERID    TestFilters::EXTRACT_POLYLINE
#define F_DISPLAYNAME "TEST - Extract Biggest Border Polyline"
#define F_DESCRIPTION ""
#define F_CATEGORY    FilterPlugin::Other
#define F_PYTHON_NAME "test_filter___extract_polyline"
...
ExtractPolylineTestFilter::ExtractPolylineTestFilter()
	: TemplateFilter(
