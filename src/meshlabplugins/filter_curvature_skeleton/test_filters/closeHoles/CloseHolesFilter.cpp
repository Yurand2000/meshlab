...
#define F_FILTERID    TestFilters::CLOSE_HOLES
#define F_DISPLAYNAME "TEST - Close Holes"
#define F_DESCRIPTION ""
#define F_CATEGORY    FilterPlugin::Other
#define F_PYTHON_NAME "test_filter___close_holes"
...
CloseHolesTestFilter::CloseHolesTestFilter()
	: TemplateFilter(
