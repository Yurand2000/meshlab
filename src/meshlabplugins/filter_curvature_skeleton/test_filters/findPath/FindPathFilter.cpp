...
#define F_FILTERID    TestFilters::FIND_PATH
#define F_DISPLAYNAME "TEST - Find Path"
#define F_DESCRIPTION ""
#define F_CATEGORY    FilterPlugin::Other
#define F_PYTHON_NAME "test_filter___find_path"
...
FindPathTestFilter::FindPathTestFilter()
	: TemplateFilter(
