...
#define F_FILTERID    TestFilters::SHOW_POLYLINE_PARENT
#define F_DISPLAYNAME "TEST - Show Polyline Parent"
#define F_DESCRIPTION ""
#define F_CATEGORY    FilterPlugin::Other
#define F_PYTHON_NAME "test_filter___show_polyline_parent"
...
ShowPolylineParentTestFilter::ShowPolylineParentTestFilter()
	: TemplateFilter(
